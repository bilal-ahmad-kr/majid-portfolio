...
import { ALL_PROJECTS } from "../data/content";
    ...
    <section className="relative overflow-hidden bg-[#F8FAFC] px-5 pt-16 pb-20 md:pt-24 md:pb-28">
      ...
      <div className="relative max-w-6xl mx-auto grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
        ...
        <div>
          ...
          >
            Every project below shipped for a real business, with a real outcome
            attached. Browse the full portfolio of websites, AI automations, and
            CRM integrations we've built.
          </motion.p>
        ...
        >
          <div className="overflow-hidden rounded-3xl shadow-[0_30px_60px_-20px_rgba(15,23,42,0.35)]">
            <img
              src="https://picsum.photos/seed/mjd-projects-hero/800/900"
              alt="A showcase of MJD AI Automation client projects"
