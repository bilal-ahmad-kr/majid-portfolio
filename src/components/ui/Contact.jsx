...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      const { contactMessagesService } = await import("../../lib/cms");
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#1E5BFF] px-6 py-3.5 text-[15px] font-semibold text-white shadow-[0_12px_28px_-8px_rgba(30,91,255,0.55)] transition-all hover:-translate-y-0.5 disabled:opacity-70 disabled:hover:translate-y-0"
              >
