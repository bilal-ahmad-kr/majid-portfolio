...
export default function Footer() {
  ...
  const fallbackServices = [
    { title: "AI Automation", slug: "ai-automation-workflow" },
    { title: "Digital Marketing", slug: "facebook-ads" },
    { title: "AI Integration", slug: "gohighlevel-crm" },
    { title: "Web Development", slug: "web-development" },
  ];
  const displayServices = services?.length > 0 ? services.slice(0, 5) : fallbackServices;
